...
def demo_conditional_logic():
    ...
    goal = Goal(action='make_coffee', target='coffee')
    plan = planner.plan(goal, state)
    print("  Water level: 20% -> Plan includes water refill")
    ...
    print("  Water level: 80% -> Plan skips water refill")
...
def demo_learning():
    ...
    print("  For 'navigate_to' failure with 'path_blocked'")
